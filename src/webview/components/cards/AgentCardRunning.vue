 ...
 *
 * Los botones son decorativos en 1.3.c — los handlers entran cuando
 * la extensión y el webview hablen via postMessage (Fase 1.4).
 *
 * La variante "standalone" (vista Single project) la creamos en
 * 1.3.d como componente separado para no inflar este con un prop
 * boolean que cambia 4 estilos.
 *
